...
public class DBWrite {
    ...
    public static void writeAllPasengers(Connection conn) {
    ...
    public static void writeAllFlights(Connection conn) {
    ...
    public static void writeAllTickets(Connection conn) {
